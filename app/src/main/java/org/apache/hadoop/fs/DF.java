...
public class DF/* extends Shell*/ {
  ...
  private static final String fsPath = "/storage/emulated/0"; // default DF refresh interval
  public static final ILogger LOG = LogFactory.getLog(DF.class);
  private static final int KILOBYTES = 1;//1024;
...
//    super(dfInterval);
    sfs = new StatFs(fsPath);
    this.dirPath = fsPath/*path.getCanonicalPath()*/;
  }
...
//    run();
    capacity = sfs.getTotalBytes() / KILOBYTES;
//    LOG.info("****<getCapacity> capacity: " + capacity);
    return capacity; 
  }
  
  public long getUsed() throws IOException { 
//    run();
    used = getCapacity() - sfs.getAvailableBytes() / KILOBYTES;
    return used;
  }
  
  public long getAvailable() throws IOException { 
//    run();
    available = sfs.getAvailableBytes() / KILOBYTES;
//    LOG.info("****<getAvailable> available: " + available);
    return available;
  }
  
  public int getPercentUsed() throws IOException {
//    run();
    percentUsed = (int)(getUsed() / getCapacity() * 100) ;
    return percentUsed;
  }
