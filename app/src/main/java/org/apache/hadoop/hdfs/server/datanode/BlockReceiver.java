...
//  public static final MyLogger LOG = DataNode.LOG;
//  static final MyLogger ClientTraceLog = DataNode.ClientTraceLog;
  
  public static final ILogger LOG = LogFactory.getLog(BlockReceiver.class);
  ...
  private final FSDataset.BlockWriteStreams streams;
...
//      streams.dataOut.flush();
//      FileOutputStream file = (FileOutputStream) streams.dataOut;
////      LOG.info("****<cotr> streams.dataOut: " + file);
//      LOG.info("****<cotr> file descriptor valid? : " + file.getFD().valid());
//      if (!file.getFD().valid()){
//           LOG.info("****<cotr> file exists? : " + streams.file.exists());
//        }
//      LOG.info("****<cotr> file descriptor valid? : " + file.getFD().valid());
//      LOG.info("****<cotr> file descriptor valid? : " + file.getFD().valid());
//      LOG.info("****<cotr> file descriptor valid? : " + file.getFD().valid());
//      LOG.info("****<cotr> file descriptor valid? : " + file.getFD().valid());
//      LOG.info("****<cotr> file.getChannel().position(): " + file.getChannel().position());
//      LOG.info("****<cotr> file.getChannel().position(): " + file.getChannel().position());
//      LOG.info("****<cotr> file.getChannel().position(): " + file.getChannel().position());
//      LOG.info("****<cotr> file.getChannel().position(): " + file.getChannel().position());
//      LOG.info("****<cotr> file.getChannel().position(): " + file.getChannel().position());
...
//    FileOutputStream file = (FileOutputStream) streams.dataOut;
//    LOG.info("****<receivePacket> streams.dataOut: " + file);
//    LOG.info("****<receivePacket> file descriptor valid? : " + file.getFD().valid());
//    if (!file.getFD().valid()){
//      LOG.info("****<receivePacket> file exists? : " + streams.file.exists());
//    }
//    try {
//      Thread.sleep(10);
...
//    LOG.info("****<receivePacket> file descriptor valid? : " + file.getFD().valid());
//    LOG.info("****<receivePacket> file descriptor valid? : " + file.getFD().valid());
//    LOG.info("****<receivePacket> file.getChannel().position(): " + file.getChannel().position());
//    LOG.info("****<receivePacket> file.getChannel().position(): " + file.getChannel().position());
//    LOG.info("****<receivePacket> file.getChannel().position(): " + file.getChannel().position());
//    LOG.info("****<receivePacket> file.getChannel().position(): " + file.getChannel().position());
//    LOG.info("****<receivePacket> file.getChannel().position(): " + file.getChannel().position());
...
//    if (LOG.isDebugEnabled()){
      LOG.info("****<receivePacket> Receiving one packet for block " + block +
...
//    file = (FileOutputStream) streams.dataOut;
//    LOG.info("****<receivePacket> streams.dataOut: " + file);
//    LOG.info("****<receivePacket> file descriptor valid? : " + file.getFD().valid());
//    if (!file.getFD().valid()){
//      LOG.info("****<receivePacket> file exists? : " + streams.file.exists());
...
//    }
    ...
    if (len == 0) {
      LOG.info("****<receivePacket> Receiving empty packet for block " + block);
    } else {
      offsetInBlock += len;
      ...
      try {
        if (!finalized) {
          ...
          if (partialCrc != null) {
            ...
            LOG.info("****<receivePacket> Writing out partial crc for data len " + len);
            partialCrc = null;
          } else {
...
//      LOG.info("****<receiveBlock>" );
//      LOG.info("****<receiveBlock> file.getChannel().position(): " + ((FileOutputStream) streams.dataOut).getChannel().position());
//    FileOutputStream file = (FileOutputStream) streams.dataOut;
//    LOG.info("****<receiveBlock> streams.dataOut: " + file);
//    LOG.info("****<receiveBlock> file descriptor valid? : " + file.getFD().valid());
//    if (!file.getFD().valid()){
//      LOG.info("****<receiveBlock> file exists? : " + streams.file.exists());
//    }    
//    LOG.info("****<receiveBlock> file descriptor valid? : " + file.getFD().valid());
//    LOG.info("****<receiveBlock> file descriptor valid? : " + file.getFD().valid());
//    LOG.info("****<receiveBlock> file descriptor valid? : " + file.getFD().valid());
//    LOG.info("****<receiveBlock> file descriptor valid? : " + file.getFD().valid());
//    LOG.info("****<receiveBlock> file.getChannel().position(): " + file.getChannel().position());
//    LOG.info("****<receiveBlock> file.getChannel().position(): " + file.getChannel().position());
//    LOG.info("****<receiveBlock> file.getChannel().position(): " + file.getChannel().position());
//    LOG.info("****<receiveBlock> file.getChannel().position(): " + file.getChannel().position());
//    LOG.info("****<receiveBlock> file.getChannel().position(): " + file.getChannel().position());
            ...
            if (pkt.lastPacketInBlock) {
              if (!receiver.finalized) {
                ...
                if (LOG.isInfoEnabled() &&
                  ...
                  LOG.info(String.format(DN_CLIENTTRACE_FORMAT,
...
//              if (LOG.isDebugEnabled()) {
                LOG.info("PacketResponder " + numTargets + " got " + ack);
//              }
