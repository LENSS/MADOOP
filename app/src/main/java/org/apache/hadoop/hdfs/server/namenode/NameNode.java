...
public class NameNode implements ClientProtocol, DatanodeProtocol,
  ...
  public static final ILogger LOG = LogFactory.getLog(NameNode.class.getName());
  public static final ILogger stateChangeLog = LogFactory.getLog("org.apache.hadoop.hdfs.StateChange");
  ...
  public static InetSocketAddress getAddress(String address) {
    LOG.info("NameNode.getAddress " + address);
  ...
  public static NameNode createNameNode(String argv[], 
    ...
    LOG.info("NameNode.createNameNode 1");
    if (startOpt == null) {
      printUsage();
      return null;
    }
    setStartupOption(conf, startOpt);
    LOG.info("NameNode.createNameNode 2");
    ...
    LOG.info("NameNode.createNameNode 3");

    NameNode namenode = new NameNode(conf);
    LOG.info("NameNode.createNameNode 4");
    return namenode;
  }
