...
public class DataNode extends Configured 
  ...
  public static final ILogger LOG = LogFactory.getLog(DataNode.class);
  ...
  public static final String DN_CLIENTTRACE_FORMAT =
        ...
        ", blockid: %s"; // block id
  static final ILogger ClientTraceLog =
...
//                                     conf.get("dfs.datanode.dns.nameserver","default"));
      String[] hosts = DNS.getHosts(conf.get("dfs.datanode.dns.interface","default"),
                                    conf.get("dfs.datanode.dns.nameserver","default"));
      machineName = hosts[0];     
