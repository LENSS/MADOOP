...
//  static final MyLogger LOG = DataNode.LOG;
  
  public static final ILogger LOG = LogFactory.getLog(DataXceiver.class);
  Socket s;
  ...
  private void readBlock(DataInputStream in) throws IOException {
    ...
    final String clientTraceFmt =
      clientName.length() > 0 && LOG.isInfoEnabled()
  ...
  private void writeBlock(DataInputStream in) throws IOException {
    ...
    LOG.info("****<writeBlock> writeBlock receive buf size " + s.getReceiveBufferSize() +
    ...
    LOG.info("****<writeBlock> Receiving block " + block + 
             " src: " + remoteAddress +
             " dest: " + localAddress);
    ...
    LOG.info("****<writeBlock> client: " + client);
    LOG.info("****<writeBlock> targets: " + targets);
    ...
    try {
        ...
        try {
          ...
          if (client.length() != 0) {
            ...
            if (/*LOG.isDebugEnabled() || */firstBadLink.length() > 0) {
              LOG.info("****<writeBlock> Datanode " + targets.length +
          ...
          if (client.length() > 0) {
            ...
            LOG.info("****<writeBlock> " + datanode.dnRegistration + ":Exception transfering block " +
      ...
      if (client.length() == 0) {
        ...
        LOG.info("****<writeBlock> Received block " + block + 
                 " src: " + remoteAddress +
                 " dest: " + localAddress +
      ...
      LOG.info("****<writeBlock> writeBlock " + block + " received exception " + ioe);
      throw ioe;
    } finally {
      ...
      IOUtils.closeSocket(mirrorSock);
      LOG.info("****<writeBlock> closing blockReceiver");
      IOUtils.closeStream(blockReceiver);
      LOG.info("****<writeBlock> blockReceiver is closed");
    }
  }
