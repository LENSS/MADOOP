 ...
 */
public class HttpServer implements FilterContainer, MadoopConstants {
  public static final ILogger LOG = LogFactory.getLog(HttpServer.class);
  ...
  protected final Context servletContext;
  protected final ServletHandler servletHandler;
...
//    }
    ...
    servletContext = new Context(Context.NO_SECURITY|Context.SESSIONS);
    webServer.setHandler(servletContext);
    servletHandler=servletContext.getServletHandler();
...
//    ServletHandler handler = webAppCtx.getServletHandler();
    for(String name : filterNames) {
      ...
      fmap.setFilterName(name);
      fmap.setDispatches(Handler.ALL);
      servletHandler.addFilterMapping(fmap);
    }
  }  
  ...
  protected String getWebAppsPath() throws IOException {
    ...
    LOG.info("****<getWebAppsPath> url: " + url);
    return url.toString();
  }
