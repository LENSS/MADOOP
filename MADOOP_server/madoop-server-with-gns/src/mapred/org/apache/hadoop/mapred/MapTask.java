...
class MapTask extends Task {
  ...
  public TaskRunner createRunner(TaskTracker tracker, 
   ...
   @Override
  public TaskRunner createLocalRunner(TaskTracker tracker, 
      TaskTracker.TaskInProgress tip) {
    return new MadoopMapRunner(tip, tracker, this.conf);
  } 
...
//    LOG.info("****<runNewMapper> job.getMapperClass(): " + job.getMapperClass().getName());

    // make a task context so we can get the classes
    org.apache.hadoop.mapreduce.TaskAttemptContext taskContext =
      new org.apache.hadoop.mapreduce.TaskAttemptContext(job, getTaskID());
//    LOG.info("****<runNewMapper> taskContext.getMapperClass(): " + taskContext.getMapperClass().getName());
    // make a mapper
