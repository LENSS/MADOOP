...
//    throw new IllegalArgumentException("Adddddddddddddd!!!!!!");
...
//    LOG.info("****<countNumOfAvailableNodes> scope: " + scope);
...
//      LOG.info("****<countNumOfAvailableNodes> count: " + count);
      Node n=getNode(scope);
//      LOG.info("****<countNumOfAvailableNodes> n: " + n);
      int scopeNodeCount=1;
      if (n instanceof InnerNode) {
        scopeNodeCount=((InnerNode)n).getNumOfLeaves();
      }
//      LOG.info("****<countNumOfAvailableNodes> scopeNodeCount: " + scopeNodeCount);
      if (isExcluded) {
        return clusterMap.getNumOfLeaves()-
