...
public class RPC {
  ...
  static VersionedProtocol waitForProxy(Class protocol,
    ...
    while (true) {
      try {
//        LOG.info("****<waitForProxy> try to getProxy");
      ...
      try {
        Thread.sleep(1000);
//        LOG.info("****<waitForProxy> wait for retry");
...
//    LOG.info("****<getProxy> after newProxyInstance");
    long serverVersion = proxy.getProtocolVersion(protocol.getName(), 
                                                  clientVersion);
    
//    LOG.info("****<getProxy> serverVersion: " + serverVersion);
//    LOG.info("****<getProxy> clientVersion: " + clientVersion);
