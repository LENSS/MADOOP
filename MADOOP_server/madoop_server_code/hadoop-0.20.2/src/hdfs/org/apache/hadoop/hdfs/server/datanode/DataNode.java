...
public class DataNode extends Configured 
  ...
  void startDataNode(Configuration conf, 
    ...
    LOG.info("****<startDataNode> machineName: " + machineName);
    InetSocketAddress nameNodeAddr = NameNode.getAddress(conf);
    LOG.info("****<startDataNode> nameNodeAddr: " + nameNodeAddr.toString());
    ...
    LOG.info("****<startDataNode> socAddr: " + socAddr.toString());
    ...
    LOG.info("****<startDataNode> simulatedFSDataset: " + simulatedFSDataset);
    ...
    selfAddr = new InetSocketAddress(ss.getInetAddress().getHostAddress(),
                                     tmpPort);
    LOG.info("****<startDataNode> selfAddr: " + selfAddr);
    ...
    LOG.info("****<startDataNode> infoSocAddr: " + infoSocAddr);
    ...
    if (conf.getBoolean(
      ...
      LOG.info("****<startDataNode> use service-level authorization security policy");
    ...
    LOG.info("****<startDataNode> ipcAddr: " + ipcAddr);
