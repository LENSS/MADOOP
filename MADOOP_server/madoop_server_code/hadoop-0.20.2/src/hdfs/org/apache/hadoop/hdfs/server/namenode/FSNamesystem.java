...
//      LOG.info("****<getAdditionalBlock> src: " + src);
//      LOG.info("****<getAdditionalBlock> clientName: " + clientName);
      INodeFileUnderConstruction pendingFile  = checkLease(src, clientName);
//      LOG.info("****<getAdditionalBlock> pendingFile: " + pendingFile);
...
//    LOG.info("****<getAdditionalBlock> fileLength: " + fileLength);
//    LOG.info("****<getAdditionalBlock> blockSize: " + blockSize);
//    LOG.info("****<getAdditionalBlock> clientNode: " + clientNode);
//    LOG.info("****<getAdditionalBlock> replication: " + replication);
...
//    LOG.info("****<checkLease> file: " + file);
  ...
  private void checkLease(String src, String holder, INode file) 
    ...
    if (holder != null && !pendingFile.getClientName().equals(holder)) {
      LOG.info("Lease mismatch on " + src + " owned by "
