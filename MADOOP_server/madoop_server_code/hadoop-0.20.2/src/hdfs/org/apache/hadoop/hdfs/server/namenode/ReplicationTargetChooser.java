...
//    LOG.info("****<chooseTarget1>");
  ...
  DatanodeDescriptor[] chooseTarget(int numOfReplicas,
                                    ...
                                    List<Node> excludedNodes,
                                    long blocksize) {
//    LOG.info("****<chooseTarget2>");
    if (numOfReplicas == 0 || clusterMap.getNumOfLeaves()==0) {
      return new DatanodeDescriptor[0];
    }
//    LOG.info("****<chooseTarget2> writer: " + writer);
      
    if (excludedNodes == null) {
      excludedNodes = new ArrayList<Node>();
    }
//    LOG.info("****<chooseTarget2> excludedNodes: " + excludedNodes);
      
    int clusterSize = clusterMap.getNumOfLeaves();
//    LOG.info("****<chooseTarget2> clusterSize: " + clusterSize);
    int totalNumOfReplicas = choosenNodes.size()+numOfReplicas;
//    LOG.info("****<chooseTarget2> totalNumOfReplicas: " + totalNumOfReplicas);
    if (totalNumOfReplicas > clusterSize) {
      numOfReplicas -= (totalNumOfReplicas-clusterSize);
      totalNumOfReplicas = clusterSize;
    }
//    LOG.info("****<chooseTarget2> numOfReplicas: " + numOfReplicas);
//    LOG.info("****<chooseTarget2> totalNumOfReplicas: " + totalNumOfReplicas);
      
    int maxNodesPerRack = 
      (totalNumOfReplicas-1)/clusterMap.getNumOfRacks()+2;
//    LOG.info("****<chooseTarget2> maxNodesPerRack: " + maxNodesPerRack);
      
    List<DatanodeDescriptor> results = 
      new ArrayList<DatanodeDescriptor>(choosenNodes);
//    LOG.info("****<chooseTarget2> results: " + results);
...
//    LOG.info("****<chooseTarget2> localNode: " + localNode);
...
//    LOG.info("****<chooseTarget3>");
    
    
    if (numOfReplicas == 0 || clusterMap.getNumOfLeaves()==0) {
      return writer;
    }
//    LOG.info("****<chooseTarget3> writer: " + writer);
    
    int numOfResults = results.size();
//    LOG.info("****<chooseTarget3> numOfResults: " + numOfResults);
...
//    LOG.info("****<chooseRandom1> nodes: " + nodes);
//    LOG.info("****<chooseRandom1> excludedNodes: " + excludedNodes);
//    LOG.info("****<chooseRandom1> blocksize: " + blocksize);
//    LOG.info("****<chooseRandom1> maxNodesPerRack: " + maxNodesPerRack);
//    LOG.info("****<chooseRandom1> results: " + results);
    do {
      DatanodeDescriptor[] selectedNodes = 
        chooseRandom(1, nodes, excludedNodes);
//        LOG.info("****<chooseRandom1> selectedNodes: " + selectedNodes);
//        LOG.info("****<chooseRandom1> nodes: " + nodes);
//        LOG.info("****<chooseRandom1> excludedNodes: " + excludedNodes);
    ...
    results.add(result);
//    LOG.info("****<chooseRandom1> result: " + result);
//    LOG.info("****<chooseRandom1> results: " + results);
    return result;
  }
  ...
  private DatanodeDescriptor[] chooseRandom(int numOfReplicas, 
                                            String nodes,
                                            List<Node> excludedNodes) {
//    LOG.info("****<chooseRandom3> numOfReplicas: " + numOfReplicas);
//    LOG.info("****<chooseRandom3> excludedNodes: " + excludedNodes);
//    LOG.info("****<chooseRandom3> nodes: " + nodes);
    List<DatanodeDescriptor> results = 
...
//    LOG.info("****<chooseRandom3> numOfAvailableNodes: " + numOfAvailableNodes);
//    LOG.info("****<chooseRandom3> numOfReplicas: " + numOfReplicas);
...
//    LOG.info("****<chooseRandom3> results: " + results);
