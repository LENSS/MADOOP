...
/** Runs a map task. */
class MadoopMapRunner extends TaskRunner {
  private static final Log LOG = LogFactory.getLog(MadoopMapRunner.class);

  public MadoopMapRunner(TaskInProgress task, TaskTracker tracker, JobConf conf) {
...
//    super.run();
////    try{
////      Child.innerChild(this);
////    }
////    catch (IOException e){
////      LOG.error("MadoopMapRunner run() error: ", e);
////    }
//  }
