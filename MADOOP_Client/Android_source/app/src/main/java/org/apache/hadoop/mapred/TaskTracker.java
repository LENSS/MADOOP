...
public class TaskTracker 
  ...
  public static final String MR_CLIENTTRACE_FORMAT =
        ...
        ", op: %s" +    // operation
        ", cliID: %s";  // task id
  public static final ILogger ClientTraceLog =
...
//    LOG.info("****<initialize> see?");

    // Clear out temporary files that might be lying around
    DistributedCache.purgeCache(this.fConf);
//    LOG.info("****<initialize> after purgeCache");
    cleanupStorage();
//    LOG.info("****<initialize> after cleanupStorage");
   ...
   */
  public TaskTracker(Context _context, JobConf conf) throws IOException {
    ...
    LOG.info("***<TaskTracker> infoAddr: " + infoAddr);
    InetSocketAddress infoSocAddr = NetUtils.createSocketAddr(infoAddr);
    String httpBindAddress = infoSocAddr.getHostName();
    LOG.info("***<TaskTracker> httpBindAddress: " + httpBindAddress);
...
//          }
        ...
        if (!shuttingDown) checkJettyPort(server.getPort());
      } catch (InterruptedException ie) {
...
//        this.runner = task.createRunner(TaskTracker.this, this);
        this.runner = task.createLocalRunner(TaskTracker.this, this);
        this.runner.start();
  ...
  public static class MapOutputServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, 
      ...
      try {
        ...
        ILogger log = (ILogger) context.getAttribute("log");
